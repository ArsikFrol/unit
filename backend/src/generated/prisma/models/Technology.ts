...
export type TechnologyWhereInput = {
  ...
  technologyId?: Prisma.StringFilter<"Technology"> | string
  ...
  bgColor?: Prisma.StringNullableFilter<"Technology"> | string | null
  colorText?: Prisma.StringNullableFilter<"Technology"> | string | null
...
export type TechnologyScalarWhereWithAggregatesInput = {
  ...
  technologyId?: Prisma.StringWithAggregatesFilter<"Technology"> | string
  ...
  bgColor?: Prisma.StringNullableWithAggregatesFilter<"Technology"> | string | null
  colorText?: Prisma.StringNullableWithAggregatesFilter<"Technology"> | string | null
}
...
export type TechnologyOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"technologyId" | "name" | "slug" | "iconUrl" | "bgColor" | "colorText", ExtArgs["result"]["technology"]>
...
export interface TechnologyDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `technologyId`
   * const technologyWithTechnologyIdOnly = await prisma.technology.findMany({ select: { technologyId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Technologies and only return the `technologyId`
   * const technologyWithTechnologyIdOnly = await prisma.technology.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Technologies and only return the `technologyId`
   * const technologyWithTechnologyIdOnly = await prisma.technology.updateManyAndReturn({
   *   select: { technologyId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface TechnologyFieldRefs {
  readonly technologyId: Prisma.FieldRef<"Technology", 'String'>
  ...
  readonly bgColor: Prisma.FieldRef<"Technology", 'String'>
  readonly colorText: Prisma.FieldRef<"Technology", 'String'>
}
